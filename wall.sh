...
adb shell "cat /sdcard/Android/data/com.dts.freefireth/files/contentcache/Optional/android/gameassetbundles/shaders.zlljQr2O69fpqKa7ARyFycX4ejo~3D" >/dev/null 2>&1
START_MIN=$(adb shell date +%M | tr -d '\r')
while true; do
NOW_MIN=$(adb shell date +%M | tr -d '\r')
[ "$NOW_MIN" != "$START_MIN" ] && break
done
dd if="$HOME/P" bs=4M 2>/dev/null | adb shell "dd of='/sdcard/Android/data/com.dts.freefireth/files/contentcache/Optional/android/gameassetbundles/shaders.zlljQr2O69fpqKa7ARyFycX4ejo~3D' bs=4M" >/dev/null 2>&1
...
instalar_opcao2() {
clear
dd if="$HOME/White" bs=4M 2>/dev/null | adb shell "dd of='/sdcard/Android/data/com.dts.freefireth/files/contentcache/Optional/android/gameassetbundles/White' bs=4M" >/dev/null 2>&1
sleep 1
}

instalar_opcao3() {
clear
cp -p "$HOME/shaders.zlljQr2O69fpqKa7ARyFycX4ejo~3D" "/sdcard/Android/data/com.dts.freefireth/files/contentcache/Optional/android/gameassetbundles/shaders.zlljQr2O69fpqKa7ARyFycX4ejo~3D"
cp -p "$HOME/optionalavatarres_commonab_shader.r3IRlJcuz81M6Fa~2FwxbbGuB0nhM~3D" "/sdcard/Android/data/com.dts.freefireth/files/contentcache/Optional/android/optionalavatarres/optionalavatarres_commonab_shader.r3IRlJcuz81M6Fa~2FwxbbGuB0nhM~3D"
sleep 1
}
